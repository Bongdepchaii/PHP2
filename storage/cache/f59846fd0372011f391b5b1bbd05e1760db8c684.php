    ...
    <div class="theme-customizer">
        ...
        <div class="customizer-sidebar-wrapper">
                ...
                <h5 class="mb-0">Cài đặt giao diện</h5>
            ...
            <div class="customizer-sidebar-body position-relative p-4" data-scrollbar-target="#psScrollbarInit">
                ...
                <div class="position-relative px-3 pb-3 pt-4 mt-3 mb-5 border border-gray-2 theme-options-set">
                    <label
                        ...
                        style="top: -12px">Điều hướng</label>
                    <div class="row g-2 theme-options-items app-navigation" id="appNavigationList">
                        <div class="col-6 text-center single-option">
                            ...
                            <label
                                ...
                                for="app-navigation-light">Sáng</label>
                        </div>
                        <div class="col-6 text-center single-option">
                            ...
                            <label
                                class="py-2 fs-9 fw-bold text-dark text-uppercase text-spacing-1 border border-gray-2 w-100 h-100 c-pointer position-relative options-label"
                                for="app-navigation-dark">Tối</label>
                        </div>
                    </div>
                </div>
                <!--! END: [Navigation] !-->
    ...
    </div><?php /**PATH C:\xampp\htdocs\lab2-30-1-26\PHP2\app\views/layouts/includes/setting_theme_admin.blade.php ENDPATH**/ ?>