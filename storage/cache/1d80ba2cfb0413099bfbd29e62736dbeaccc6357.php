<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                        <div class="avatar-image avatar-sm me-2">
                             <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($_SESSION['user_name'] ?? 'User')); ?>&background=random" class="rounded-circle" style="width: 32px; height: 32px;">
                        </div>
  ...
  </nav><?php /**PATH C:\xampp\htdocs\lab2-30-1-26\PHP2\app\views/layouts/includes/header.blade.php ENDPATH**/ ?>