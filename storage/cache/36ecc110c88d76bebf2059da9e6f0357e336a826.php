...
<div class="py-2">
    <h4 class="fw-bold mb-4">GIỎ HÀNG (<span><?php echo e(count($cart)); ?></span> sản phẩm)</h4>
            ...
            <?php else: ?>
                ...
                <div class="p-3 border-bottom align-items-center d-flex flex-column flex-md-row cart-row"
                    ...
                    <div class="d-flex align-items-center w-100" style="flex: 2;">
                        <a href="product/detail/<?php echo e($item['id_product']); ?>" class="nav-link"><img src="<?php echo e($imgSrc); ?>" class="rounded-2 border"
                             alt="<?php echo e($item['product_name']); ?>"
                             style="width: 80px; height: 80px; object-fit: cover;"></a>
                        <div class="ms-3">
                            <a href="product/detail/<?php echo e($item['id_product']); ?>" class="nav-link"><h6 class="mb-1 fw-bold"><?php echo e($item['product_name']); ?></h6></a>
                            <small>SL: <?php echo e($item['stock']); ?></small><br>
                            <a href="/cart/delete/<?php echo e($item['id']); ?>"
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center w-100 mt-2 mt-md-0" style="flex: 1;">
                        <div class="input-group input-group-sm" style="width: 110px;">
                            <button class="btn btn-outline-secondary btn-qty-minus"
                                    type="button"
                                    data-cart-id="<?php echo e($item['id']); ?>"
                                    <?php echo e($item['quantity'] <= 1 ? 'disabled' : ''); ?>>−</button>
                            ...
                            <button class="btn btn-outline-secondary btn-qty-plus"
                                    type="button"
                                    data-cart-id="<?php echo e($item['id']); ?>"
                                    <?php echo e($item['quantity'] >= $item['stock'] ? 'disabled' : ''); ?>>+</button>
                        </div>
                    </div>
