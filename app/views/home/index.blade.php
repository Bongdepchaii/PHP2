                ...
                <div class="card h-100 shadow-sm border-0 product-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <span class="card-title mb-1 fw-bold text-truncate">
                            <a href="/product/detail/{{ $item['id'] }}" class="text-decoration-none text-primary">Số lượng: {{ $qtyHelperHome->getTotalQty($item) }}</a>
                        </span>
                        <!-- <p class="card-text text-muted small mb-2 flex-grow-1">{{ substr($item['mota'], 0, 80) . "..." }}</p> -->
                        
                        <div class="mt-auto pt-3 border-top">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <div class="fw-bold text-danger fs-5">{{ $item['price_vnd'] ?? number_format($item['price'], 0, ',', '.') . 'đ' }}</div>
                            </div>
